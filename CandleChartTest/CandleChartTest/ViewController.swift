...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let chartPoints = [
            ChartPointCandleStick(date: date("2020-04-02T09:00:00"), formatter: displayFormatter, high: 40, low: 37, open: 39.5, close: 39),
            ChartPointCandleStick(date: date("2020-04-02T09:05:00"), formatter: displayFormatter, high: 39.8, low: 38, open: 39.5, close: 38.4),
            ChartPointCandleStick(date: date("2020-04-02T09:10:00"), formatter: displayFormatter, high: 43, low: 39, open: 41.5, close: 42.5),
            ChartPointCandleStick(date: date("2020-04-02T09:15:00"), formatter: displayFormatter, high: 48, low: 42, open: 44.6, close: 44.5),
            ChartPointCandleStick(date: date("2020-04-02T09:20:00"), formatter: displayFormatter, high: 45, low: 41.6, open: 43, close: 44),
            ChartPointCandleStick(date: date("2020-04-02T09:25:00"), formatter: displayFormatter, high: 46, low: 42.6, open: 44, close: 46),
            ChartPointCandleStick(date: date("2020-04-02T09:30:00"), formatter: displayFormatter, high: 47.5, low: 41, open: 42, close: 45.5),
            ChartPointCandleStick(date: date("2020-04-02T09:35:00"), formatter: displayFormatter, high: 50, low: 46, open: 46, close: 49),
            ChartPointCandleStick(date: date("2020-04-02T09:40:00"), formatter: displayFormatter, high: 45, low: 41, open: 44, close: 43.5),
            ChartPointCandleStick(date: date("2020-04-02T09:45:00"), formatter: displayFormatter, high: 47, low: 35, open: 45, close: 39)
        ]
        
        let barValues: [Double] = [15,20,54,24,23,43,23,43,23,43,23,43,55, 66, 77, 88, 99]
        let candleChart = ZCandleChart(candleChartFrame: CGRect(x: 0, y: 70, width: self.view.bounds.width, height: self.view.bounds.height - 70), barChartFrame: CGRect(x: 0, y: self.view.bounds.height - 180, width: self.view.bounds.width, height: 100))
