//
//  CandleStickInteractiveViewController.swift
//  CandleChartTest
//
...
class CandleStickInteractiveViewController: UIViewController {
    @IBOutlet weak var backBtn: UIButton!
    fileprivate var chart: Chart? // arc
    fileprivate var candleStickLayer: ChartPointsCandleStickViewsLayer<ChartPointCandleStick, ChartCandleStickView>?
    fileprivate var infoView: InfoWithIntroView?
    fileprivate var trackerLayer: ChartPointsTrackerLayer<ChartPointCandleStick>!
    ...
    override func viewDidLoad() {
        ...
        let chartPoints = [
            ...
            ChartPointCandleStick(date: date("10.10.2015"), formatter: displayFormatter, high: 42, low: 35, open: 30, close: 41),
            ...
            ChartPointCandleStick(date: date("23.10.2015"), formatter: displayFormatter, high: 32, low: 25, open: 23, close: 30),
            ChartPointCandleStick(date: date("24.10.2015"), formatter: displayFormatter, high: 33, low: 25, open: 22, close: 30),
            ChartPointCandleStick(date: date("25.10.2015"), formatter: displayFormatter, high: 34, low: 29, open: 20, close: 31),
        ...
        let chartPoints2 = [
            ChartPointCandleStick(date: date("01.10.2015"), formatter: displayFormatter, high: 39.8, low: 38, open: 39.5, close: 38.4),
            ChartPointCandleStick(date: date("02.10.2015"), formatter: displayFormatter, high: 48, low: 42, open: 44.6, close: 44.5),
            ChartPointCandleStick(date: date("03.10.2015"), formatter: displayFormatter, high: 35, low: 31, open: 31, close: 33),
            ChartPointCandleStick(date: date("04.10.2015"), formatter: displayFormatter, high: 32, low: 30, open: 31, close: 30.6),
            ChartPointCandleStick(date: date("05.10.2015"), formatter: displayFormatter, high: 45, low: 41.6, open: 43, close: 44),
            ChartPointCandleStick(date: date("06.10.2015"), formatter: displayFormatter, high: 46, low: 42.6, open: 44, close: 46),
            ChartPointCandleStick(date: date("07.10.2015"), formatter: displayFormatter, high: 47.5, low: 41, open: 42, close: 45.5),
            ChartPointCandleStick(date: date("08.10.2015"), formatter: displayFormatter, high: 50, low: 46, open: 46, close: 49),
        ...
        let viewGenerator = {(chartPointModel: ChartPointLayerModel<ChartPointCandleStick>, layer: ChartPointsViewsLayer<ChartPointCandleStick, ChartCandleStickView>, chart: Chart) -> ChartCandleStickView? in
            ...
            let (rectTop, rectBottom, fillColor) = closeScreenY < openScreenY ? (closeScreenY, openScreenY, UIColor.red) : (openScreenY, closeScreenY, UIColor.blue)
            let v = ChartCandleStickView(lineX: screenLoc.x, width: 5, top: highScreenY, bottom: lowScreenY, innerRectTop: rectTop, innerRectBottom: rectBottom, fillColor: fillColor, strokeColor: fillColor, strokeWidth: 0.5)
            v.isUserInteractionEnabled = false
            return v
        }
        
        candleStickLayer = ChartPointsCandleStickViewsLayer<ChartPointCandleStick, ChartCandleStickView>(xAxis: xAxisLayer.axis, yAxis: yAxisLayer.axis, innerFrame: innerFrame, chartPoints: chartPoints, viewGenerator: viewGenerator)
        
        
        
        // 글자 나오는 뷰
        infoView = InfoWithIntroView(frame: CGRect(x: 10, y: 70, width: view.frame.size.width, height: infoViewHeight))
        view.addSubview(infoView!)
        
        trackerLayer = ChartPointsTrackerLayer(xAxis: xAxisLayer.axis, yAxis: yAxisLayer.axis, chartPoints: chartPoints, lineColor: UIColor.red, lineWidth: 1)
...
extension CandleStickInteractiveViewController: TrackerLayerDelegate {
