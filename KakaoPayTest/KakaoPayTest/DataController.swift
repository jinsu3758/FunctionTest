...
class DataController: NSObject {
    ...
    func requestPay(completion: @escaping (PayInfo?) -> Void) {
        ...
        api.request(for: PayInfo.self, with: body, method: .post, header: header, completion: { result in
            switch result {
...
//            }
    ...
    func requestPayApprove(payId: String, token: String, completion: @escaping (String?) -> Void) {
